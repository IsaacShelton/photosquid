// Serialization and Deserialization for std::time::Instant
// Not ideal, but good for prototyping
// From https://github.com/serde-rs/serde/issues/1375#issuecomment-419688068
